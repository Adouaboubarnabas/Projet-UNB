<!-- Modal d'ajouter-->
<div class="modal fade" id="modal_carte" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <form method="POST" action="{{route('etudiant')}}">
            @csrf
                ...
                <div><br>
                    ...
                    <a type="button" href="{{('etudiant')}}" class="btn btn-primary">Imprimer la carte</a>
                    </div>
                    </form>
                    </div>
